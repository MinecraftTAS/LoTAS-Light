...
public record SavestateDisconnectPayload() implements CustomPacketPayload {
	public static final CustomPacketPayload.Type<SavestateDisconnectPayload> ID = new CustomPacketPayload.Type<>(ResourceLocation.fromNamespaceAndPath("lotaslight", "networking/disconnect"));
